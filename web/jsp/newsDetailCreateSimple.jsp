...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath() %>/ckeditor/_samples/sample.css">
</head>
<body>
<%--实现文件上传操作 form必须改为 多类型内容提交enctype="multipart/form-data" 而且必须是post--%>
<form name="dataFrm" id="dataFrm" enctype="multipart/form-data" action="<%=request.getContextPath()%>/news?opr=addNews"
      method="post">
    <input type="hidden" name="opr" value="addNews">
    <table width="100%" border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
            ...
            <td style="text-align:left;">
                <div id="xToolbar"></div>
                <textarea id="newscontent" name="newscontent" class="ckeditor" rows="8" cols="30"></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align:center;" colspan="2">
                ...
                <button type="button" class="page-btn" name="return"
                        onclick="javascript:location.href='newsDetailList.jsp'">返回
                </button>
            </td>
        </tr>
        </tbody>
